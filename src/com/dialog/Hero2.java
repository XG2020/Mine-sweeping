...
import com.tools.Tools;
 ...
 // 高级排行榜
public class Hero2 extends JDialog{
		...
		public Hero2(MainFrame mainframe) {
		...
		public void init(){
			...
			time1 = new JLabel(""+Tools.time001);
			time2 = new JLabel(""+Tools.time002);
			time3 = new JLabel(""+Tools.time003);
			name1 = new JLabel(" "+Tools.name001);
			name2 = new JLabel(" "+Tools.name002);
			name3 = new JLabel(" "+Tools.name003);
		...
		class HeroListener implements ActionListener{
			public void actionPerformed(ActionEvent e){
				...
				if(command.equals("确定")){
					...
					Tools.name002 = " 匿名";
					Tools.name003 = " 匿名";			
					time1.setText(""+Tools.time001);
					name1.setText(Tools.name001);				
					time2.setText(""+Tools.time002);
					name2.setText(Tools.name002);			
					time3.setText(""+Tools.time003);
					name3.setText(Tools.name003);
					//dispose();
				}
			}
		}
