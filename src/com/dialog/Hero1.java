...
import com.tools.Tools;
 ...
 // 中级排行榜
public class Hero1 extends JDialog{
		...
		public Hero1(MainFrame mainframe) {
		...
		public void init(){
			...
			time1 = new JLabel(""+Tools.time01);
			time2 = new JLabel(""+Tools.time02);
			time3 = new JLabel(""+Tools.time03);
			name1 = new JLabel(" "+Tools.name01);
			name2 = new JLabel(" "+Tools.name02);
			name3 = new JLabel(" "+Tools.name03);
		...
		class HeroListener implements ActionListener{
			public void actionPerformed(ActionEvent e){
				...
				if(command.equals("确定")){
					...
					Tools.name02 = " 匿名";
					Tools.name03 = " 匿名";			
					time1.setText(""+Tools.time01);
					name1.setText(Tools.name01);				
					time2.setText(""+Tools.time02);
					name2.setText(Tools.name02);			
					time3.setText(""+Tools.time03);
					name3.setText(Tools.name03);
					//dispose();
				}
			}
		}
